...
/**
 * Fired whenever a lavaplayer stops playing, whether stopped manually or finishing naturally.
 * <p>
...
public class LavaPlayerStopPlayingEvent extends Event {
  ...
  public LavaPlayerStopPlayingEvent(Block block, String identifier) {
    super(true);
    this.block = block;
